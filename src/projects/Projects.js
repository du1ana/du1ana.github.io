...
function ProjectCard(props) {
  return(
    <div className="card mx-2 my-3 p-1 align-top" style={{maxWidth: "20rem", overflow:"hidden"}}>
      <img className="card-img-top" src={props.data.img} alt={props.data.name} style={{maxHeight:'155px'}}/>
